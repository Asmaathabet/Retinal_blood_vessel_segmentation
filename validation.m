...
%Ground truth image is taken from drive database.
%image : Segmented image output

image=im2uint8(image);

%TP - True Positives 
%True positive - Any pixel marked as vessel in both ground truth and segemented image
...
%TN - True Negative : Any pixel marked as background in both ground truth
%and segmented image
